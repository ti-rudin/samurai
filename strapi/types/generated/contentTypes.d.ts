...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cars: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    finalCost: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    orderstatus: Schema.Attribute.Enumeration<
      ['new', 'in_progress', 'suspended', 'completed', 'cancelled', 'deleted']
    >;
...
export interface ApiPartPart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isRecomended: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    partstatus: Schema.Attribute.Enumeration<
      ['pending_from_client', 'need_to_order', 'ordered', 'onbase']
    >;
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    executor: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    executorPays: Schema.Attribute.JSON;
    executorPercentage: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    isRecomended: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    order: Schema.Attribute.Relation<'manyToOne', 'api::order.order'>;
    publishedAt: Schema.Attribute.DateTime;
    status_of_work: Schema.Attribute.Enumeration<
